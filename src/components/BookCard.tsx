...
export default function BookCard({ audiobook }: { audiobook: Audiobook }) {
	return (
		<Link
		...
		>
			...
			<div className="relative h-2 mb-2">
				<div
					className="absolute h-2 bg-orange-300 rounded-full z-10"
					style={{ width: `${(audiobook.listenedSeconds || 0 / audiobook.totalSeconds) * 100}%` }}
				/>
